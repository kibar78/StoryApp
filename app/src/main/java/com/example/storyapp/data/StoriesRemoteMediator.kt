...
import com.example.storyapp.data.local.room.RemoteKeys
    ...
    override suspend fun load(
        ...
        try {
            ...
            database.withTransaction {
                ...
                val storyEntityMap = responseData.map {
                    with(it) {
                        StoryEntity(
                            id, photoUrl as String, createdAt, name as String, description, lon, lat
                        )
                    }
                }
                database.storiesDao().insertQuery(storyEntityMap)
            }
